namespace Uploadify.Server.Domain.Infrastructure.Localization;
...
public static class Translations
{
    public static class Validations
    {
        ...
        public const string InvalidCredentials = BaseValidations + ".signin.invalid_user_name_or_password";
